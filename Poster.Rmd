...
main_findings:
  ...
  - '<img src = "img/main_image.png" class = "main_pic" width = "400px">'
...
- (advanced version) create a sleek website to show off their work through RMarkdown and github pages
...
- (Optional) Upload to `github` and use *GitHub pages* to render a sleek looking web page

# Resources

Material below available at <a href = "go.ncsu.edu/uscots2023" style = "color:blue;">go.ncsu.edu/uscots2023</a> (or use the QR code)  

- Example course notes available (including API querying)
